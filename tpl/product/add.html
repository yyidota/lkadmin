                                ...
                                <div class="col-sm-12">
                                    <form class="form-horizontal" role="form" method="get" action="../server/ajaxReturn.json" data-validate="validate2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                               <select class="form-control" name="category">
                                                <option value="0101">屈曲约束支撑</option>
                                                <option value="0102">软钢阻尼器</option>
                                                <option value="0103">墙板阻尼器</option>
                                                <option value="0200">软件报价</option>
                                                <option value="0201">多高层结构</option>
                                                <option value="0202">厂房结构</option>
                                                <option value="0203">空间结构</option>
                                                <option value="0204">MTStool工具箱</option>
                                                <option value="0301">涉外项目</option>
                                                <option value="0302">国内项目</option>
                                                <option value="0401">减震演示</option>
                                                <option value="0402">软件演示</option>
                                                </select> 
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="关键字" name="author">
                                            </div>
                                            <p class="col-sm-6 help-block"></p>
                                        </div>
                                        <hr/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="查看次数" name="author">
                                            </div>
                                            <p class="col-sm-6 help-block"></p>
                                        </div>
                                        <hr/>
